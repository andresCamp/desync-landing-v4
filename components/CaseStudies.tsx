...
const StackedCardTestimonials = () => {
  ...
  return (
    <section className="bg-white py-24 px-4 lg:px-8 grid items-center grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-4 overflow-hidden w-screen">
      <div className="p-4">
        <h3 className="text-5xl font-semibold">Our Casestudies</h3>
